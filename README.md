...
系統會自動：
- 🔍 **偵測教材**: 掃描課程第一頁，檢查是否有附帶的學習資料
- 📥 **自動下載**: 找到教材後自動下載到 `course_materials/` 資料夾
- 📝 **保持原名**: 保留原始檔名，通常為 PDF 格式的講義
- 🎯 **智慧判斷**: 沒有教材的課程會顯示「無教材」，不會產生錯誤

```bash
# 範例：課程 49 有 PDF 講義
uv run channel-plus --link https://channelplus.ner.gov.tw/viewalllang/49 --dry-run

# 輸出：
# 📚 Checking for course materials...
# ✅ Found 1 course materials
#   • 99長青天地生活日語講義(2).pdf -> https://channelplus.ner.gov.tw/api/files/...
